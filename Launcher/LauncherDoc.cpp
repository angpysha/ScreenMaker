...
BOOL CLauncherDoc::OnNewDocument()
{
...
// CLauncherDoc serialization

void CLauncherDoc::Serialize(CArchive& ar)
{
	if (ar.IsStoring())
	{
...
void CLauncherDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
void CLauncherDoc::InitializeSearchContent()
{
...
void CLauncherDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
